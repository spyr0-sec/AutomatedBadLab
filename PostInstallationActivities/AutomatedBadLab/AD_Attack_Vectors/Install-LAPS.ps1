...
Function Install-LAPS {
    ...
    # Pick a real computer object to install LAPS on
    $LAPSComputer = Get-ADComputer -Filter * -Properties Description |`
    Where-Object { $_.Description -notlike '*AutomatedBadLab*' } | Get-Random -Count 1
    ...
    New-GPO -Name $LapsGPOName | New-GPLink -Target $LapsOU -Enforced Yes
